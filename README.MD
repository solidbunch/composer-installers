...
* An `installer-paths` key made only of slashes is skipped when the install path is resolved; the package falls back to the next matching rule or to `vendor/`.
